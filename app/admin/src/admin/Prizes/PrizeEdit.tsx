...
import { ArrayInput, AutocompleteInput, DeleteWithConfirmButton, Edit, ImageInput, Labeled, NumberField, ReferenceInput, SaveButton, SelectInput, SimpleForm, TextField, TextInput, Toolbar, required, useEditContext } from 'react-admin';
  ...
  return (
    <Edit transform={transform} redirect="edit">
      <SimpleForm toolbar={<PrizeEditToolbar />} warnWhenUnsavedChanges>
        ...
        <SelectInput source="recommendedRank" label="Recommended Rank" validate={[required()]} choices={[
          { id: 'ALL', name: 'ALL' },
          { id: 'DAN', name: 'DAN' },
          { id: 'SDK', name: 'SDK' },
          { id: 'DDK', name: 'DDK' },
        ...
        <div style={{ display: 'flex', flexDirection: 'column', width: '100%' }}>
          <ImageInput source="imageEncoded" label="Prize Image" placeholder="Drop a picture to upload, or click to select it. An image preview will be displayed below." removeIcon={RemoveCircle} accept={{
            'image/*': ['.png', '.jpg']
          }} minSize={5000} maxSize={1000000} >
            <EditImage />
          </ImageInput>
